...
class PolisDaemon():
    def __init__(self, **kwargs):
        ...
        # memoize calls to some polisd methods
    ...
    @classmethod
    def from_polis_conf(self, polis_dot_conf):
    ...
    def get_my_gobject_votes(self, object_hash):
        ...
        if not self.gobject_votes.get(object_hash):
            ...
            self.gobject_votes[object_hash] = polislib.parse_raw_votes(raw_votes)
    ...
    def we_are_the_winner(self):
        ...
        winner = polislib.elect_mn(block_hash=current_block_hash, mnlist=mn_list)
        my_vin = self.get_current_masternode_vin()
    ...
    def estimate_block_time(self, height):
        ...
        future_seconds = polislib.blocks_to_seconds(diff)
