...
def go_list_proposals():
    items = [
        {u'AbsoluteYesCount': 1000,
         ...
         u'DataHex': u'',
         u'DataString': u'[["proposal", {"end_epoch": 2122520400, "name": "dean-miller-5493", "payment_address": "yjJqmSFVG4Hr4p1eNcBSBQkoWacnsKtEE5", "payment_amount": 25.75, "start_epoch": 1474261086, "type": 1, "url": "http://dashcentral.org/dean-miller-5493"}]]',
        ...
        {u'AbsoluteYesCount': 1000,
         ...
         u'DataHex': u'',
         u'DataString': u'[["proposal", {"end_epoch": 2122520400, "name": "fernandez-7625", "payment_address": "yjJqmSFVG4Hr4p1eNcBSBQkoWacnsKtEE5", "payment_amount": 25.75, "start_epoch": 1474261086, "type": 1, "url": "http://dashcentral.org/fernandez-7625"}]]',
...
def proposal():
    ...
    pobj = Proposal(
        ...
        payment_address="yjJqmSFVG4Hr4p1eNcBSBQkoWacnsKtEE5",
        payment_amount=13
    )
...
def test_proposal_is_valid(proposal):
    ...
    proposal.payment_address = 'TXDSaTXerg68SCyLkWw2ERsqoTMWRBZiZu'
    assert proposal.is_valid() is False

    proposal.payment_address = 'TXDSaTXerg68SCyLkWw2ERsqoTMWRBZiZr'
    assert proposal.is_valid() is False
    ...
    proposal.payment_address = 'yjJqmSFVG4Hr4p1eNcBSBQkoWacnsKtEE5'
    assert proposal.is_valid() is True
