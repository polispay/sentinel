...
class GovernanceClass(object):
    ...
    def polisd_serialise(self):
        import polislib
        return polislib.SHIM_serialise_for_polisd(self.serialise())
